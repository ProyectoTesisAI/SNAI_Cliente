...
@Named(value = "panelAdolescenteInfractorCAIConCAIControlador")
@ViewScoped
public class PanelAdolescenteInfractorCAIConCAIControlador implements Serializable{
    ...
    public void init() {
        ...
        listadoAdolescentesInfractoresCAI=servicio.listaAdolescentesInfractoresAsignadosCAI();
